...
<figure class="fade-in" class:sm={size === "sm"}>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 261.02 58.1">
    <defs>
      <style>
        .cls-1 {
          fill: #fff;
